 ...
 * triangles pointés par \a t. Quand \a hasNormals est faux (0) elle
 * force le calcul des normales par triangle et les affecte aux
 * sommets. */
surface_t * newSurface(triangle_t * t, int n, int hasNormals) {
