...
extern "C" {
  ...
  enum {
    CL_OPT_BACK_FACE_CULLING = 1,
    CL_OPT_ALPHA_BLENDING = 2,
    CL_OPT_SHADING = 4,
    CL_OPT_TEXTURING = 8,
    CL_OPT_COLOR_MATERIAL = 16,
  };
  ...
  extern void claude_enable(uint32_t opt);
  extern void claude_disable(uint32_t opt);
  extern int  claude_is_enabled(uint32_t opt);
