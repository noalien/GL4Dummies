...
void gl4dhDraw(void) {
  ...
  glBlitFramebuffer(0, 0, _w, _h, vp[0], vp[1], vp[2], vp[3], GL_COLOR_BUFFER_BIT, GL_LINEAR);
  glBlitFramebuffer(0, 0, _w, _h, vp[0], vp[1], vp[2], vp[3], GL_DEPTH_BUFFER_BIT, GL_NEAREST);
  glBindFramebuffer(GL_FRAMEBUFFER, 0);
