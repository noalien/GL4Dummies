 ...
 *
 * Exercice (corrigé dans sc_02_01_simpleTextureFromBMP-1.0) :
 * utiliser une fonctionnalité SDL2 ou SDL2_image ou autres pour
 * charger une image à partir d'un fichier et l'appliquer avec
 * interpolation linéaire au quadrilatère.
 *
 * Exercice (corrigé en 1.1) : remplacer la texture ci-dessous par un
 * damier noir et blanc de 50x50 cases en utilisant très peu de
 * données. Puis (corrigé en 1.2) remplacer le vao créé manuellement
 ...
 * (corrigé en 1.3). Enfin (corrigé en 1.4), placer le quadrilatère
