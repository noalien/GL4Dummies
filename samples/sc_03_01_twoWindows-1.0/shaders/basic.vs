 ...
 * coordonnées spaciales 3D, vecteur normal et coordonnée de
 * texture. De plus, une matrice de projection, une matrice vue et une
 * matrice de modélisation sont envoyées par GL4Dummies, nous les
...
void main(void) {
   ...
   * vsoColor est "blanc" stocké dans un vecteur 4D (w = 1) */
  vsoColor = vec4(1.0);
